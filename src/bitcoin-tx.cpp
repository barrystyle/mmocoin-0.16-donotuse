...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help") || gArgs.IsArgSet("-version"))
    {
        ...
        std::string strUsage = strprintf(_("%s mmocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mmocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mmocoin transaction") + "\n" +
              "  mmocoin-tx [options] -create [commands]   " + _("Create hex-encoded mmocoin transaction") + "\n" +
              "\n";
