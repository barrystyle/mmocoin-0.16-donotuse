...
/** mmocoin: Number of consecutive PoS headers are allowed from a single peer. Used to prevent out of memory attack. */
...
public:
    ...
    uint256 hashCheckpointKnown; // mmocoin: known sent sync-checkpoint
    ...
    // mmocoin: used to detect branch switches
