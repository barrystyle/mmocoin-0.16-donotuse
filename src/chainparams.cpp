...
public:
    CMainParams() {
        ...
        consensus.nStakeMaxAge = 2 * 30 * 24 * 60 * 60;
        ...
        genesis = CreateGenesisBlock(1519171200, 1519171200, 87389, 0x1e0fffff, 1, 0);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000006670ae1c3f7712d3d22d4279b4d72d017c065c8c908c14e0d04191b4108"));
        assert(genesis.hashMerkleRoot == uint256S("0xe2a49c9b4be4b1bca1d1c22aaf86406f8a5efe3335707426b2731f97ed9c777b"));
        ...
        checkpointData = {
            {
                {     0, uint256S("0x000006670ae1c3f7712d3d22d4279b4d72d017c065c8c908c14e0d04191b4108")},
            }
        };

        chainTxData = ChainTxData{
            // Data as of block d25bd7cee527575afcf32d69e0438161899257f911fc507e71c78526e88b3e13 (height 401725).
            1519171200, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("tseed.mmocoin.net");
        vSeeds.emplace_back("tseed2.mmocoin.net");
        vSeeds.emplace_back("tseed.mmocoin-library.org");
